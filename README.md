...
3.  **Setup Environment Variables:**
    ...
    OVERLAY_CONTROL_SECRET=generate_a_long_random_secret
...
1.  Start the development server:
    ...
    npm run dev
    ```
2.  Open `http://localhost:3000?controlKey=generate_a_long_random_secret` in your browser.
...
2.  Set URL to `http://localhost:3000?controlKey=generate_a_long_random_secret`.
