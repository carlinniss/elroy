...
4. Add the same secret to the OBS browser source URL, for example `https://your-elroy-site.vercel.app/?controlKey=your-secret`, so the overlay can securely poll and acknowledge live prompts.
